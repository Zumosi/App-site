...
$message_contact="Ici on écrit n'importe quel message";
$object_contact="Dans le cas d'une demande particulière";
...
//=====Définition du sujet.
    $sujet = "Inscription Service Athome";
//=========
...
//=====Déclaration des messages au format texte et au format HTML.
    ...
    $message_html = "<html><head></head><body>Bonjour, <br> <br> Suite à votre demande de réinitialisation de mot de passe, nous vous en communiquons un nouveau : <br> <br>  $newpassw <br> <br> Pensez bien à le changer après votre connexion. <br> <br> L'équipe Athome </body></html>";
//==========
