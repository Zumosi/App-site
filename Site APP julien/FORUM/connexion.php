...
echo'fifi1';
...

    {
        ...
        FROM forum_membres WHERE membre_pseudo = :pseudo');
            ...
            if (isset($_POST['password'])) // Acces OK !
...

            {
                ...
                echo'fifi1';
                $message = '<i class="oups"><p>Une erreur s\'est produite 
        ...
        pour revenir à la page d accueil</p></i>';
...
$page = htmlspecialchars($_POST['pseudo']);
