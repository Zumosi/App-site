...
//on va afficher le haut de la page, c'est-à-dire qu'on va écrire le nombre de pages et des informations sur le visiteur.
...
<img src="NewSubject.png" alt="New subject" title="new subject" /></a>';
$query->CloseCursor();
...
if ($query->rowCount()>0)
{
    ...
    <table>
        <tr>
            <th><img src="annonce.png" alt="Annonce" /></th>
        ...
        while ($data=$query->fetch())
        {
            ...
            echo'<tr><td><img src="annonce.png" alt="Annonce" /></td>
...
if ($query->rowCount()>0)
{
    ...
    <table>
        <tr>
            <th><img src="message.png" alt="Message" /></th>
            <th class="titre"><strong>Titre</strong></th>
            <th class="nombremessages"><strong>Réponses</strong></th>
            <th class="nombrevu"><strong>Vus</strong></th>
            <th class="auteur"><strong>Auteur</strong></th>
        ...
        while ($data = $query->fetch())
        {
            ...
            echo'<tr><td><img src="message.png" alt="Message" /></td>
            ...
            echo '<td class="derniermessage">
                 ...
                 <a href="voirtopic.php?t='.$data['topic_id'].'&amp;page='.$page.'#p_'.$data['post_id'].'">'.date('H\hi \l\e d M y',$data['post_time']).'</a></td></tr>';
