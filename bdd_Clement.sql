...
--
-- Hôte : localhost
-- Généré le :  lun. 11 juin 2018 à 12:52
...
(1, 'Appartement', '', '', 0, 1),
(2, 'Maison', '', '', 0, 1),
(3, 'VILLA', 'Clement phu', '1 square du midi', 10, 4),
(4, 'appartement', 'Clement phu', '1 square du midi', 3, 4),
(5, 'villa', 'Clement phu', '1 square du midi', 3, 4),
(6, 'a', 'Clement phu', '1 square du midi', 3, 4),
(7, 'villa', 'Clement phu', '1 square du midi', 3, 5),
(8, 'a', 'Clement phu', '1 square du midi', 0, 5),
(9, 'a', 'Clement phu', '1 square du midi', 0, 5);
...
(5, 'a', 'a', 0000000000, '$6$rounds=3232$yRyJDM8YPUMMRAJF$RUAfImrssOz6DtOdXKeRpNaiHEc3DWWUvcVvk5.oi5FQkdSgVOOdpBJHkle0kyrG095ytILFXS8Fzx3S5Q.Dn1', 'client principal', 'a@a.a', 0);
...
--
ALTER TABLE `habitation`
  MODIFY `id_habitation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
